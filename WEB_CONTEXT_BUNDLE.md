...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-graph-046-word-representable-near-triangulations-186be399-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GRAPH-046"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-graph-046-word-representable-near-triangulations-186be399-v1",
      "problem_contract_sha256": "32830f87712b878bfc16eb1e1d7e942eec2778a52b11dab273d22ab17cbbb275",
      "problem_id": "problem:um-graph-046-word-representable-near-triangulations-186be399",
      "route_id": "route:um-graph-046-word-representable-near-triangulations-186be399-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-graph-046-word-representable-near-triangulations-186be399-source-fidelity-01",
      "graph_id": "graph:um-graph-046-word-representable-near-triangulations-186be399-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-graph-046-word-representable-near-triangulations-186be399-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-graph-046-word-representable-near-triangulations-186be399-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Characterize word-representable near-triangulations containing K₄."
          },
          "statement_sha256": "2b606364d9f96be186d32d9d646446d4094ec83871e35e28fd07ffac5eba474b"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-graph-046-word-representable-near-triangulations-186be399-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-graph-046-word-representable-near-triangulations-186be399-root",
      "route_id": "route:um-graph-046-word-representable-near-triangulations-186be399-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-graph-046-70a2aeafe334",
        "url": "https://www.unsolvedmath.com/problems/GRAPH-046"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
